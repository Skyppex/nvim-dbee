...
return function()
  ...
  vim.fn["remote#host#RegisterPlugin"]("nvim_dbee", "0", {
    ...
    { type = "function", name = "DbeeConnectionGetStructureAsync", sync = false, opts = vim.empty_dict() },
    ...
    { type = "function", name = "DbeeConnectionListDatabasesAsync", sync = false, opts = vim.empty_dict() },
    ...
    { type = "function", name = "DbeeConnectionSelectDatabaseAsync", sync = false, opts = vim.empty_dict() },
